...
- 主な機能: 他のゲームプレイ中の自動終了、RDP 接続時の最小化
...
- Windows 環境前提 (PowerShell Core 7+)
...
- `chromerdp-clicker-minimalize.ps1`: Chrome RDP セッション切断/接続を検知して最小化
...
- コミット・プッシュ前: Conventional Commits 確認、Lint 確認
- PR 作成前: 機密情報確認
